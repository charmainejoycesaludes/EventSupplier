...
if(isset($_POST['signin'])){   
  ...
  $sqladdfood = "INSERT INTO signup (fname,password) VALUES('$ea','$pass')";
...
<span class="w-100 bg-dark d-flex justify-content-center p-5">
    <div class="form_container">
        <div class="logo_container"></div>
        <div class="title_container">
            <p class="title">Sign Up for Account</p>
            <span class="subtitle">Get started with our web portal, sign up an account and enjoy the experience.</span>
        </div>
        <br>
        <form method="post">
        ...
        <button title="Sign In" type="submit" name="signin" class="sign-in_btn">
        ...
        <a href="alivelogin.php" class="sign-in_apl text-decoration-none">
