...
<!-- Para maidentify kung anong klaseng supplier yun, para kay ADMIN -->
<span>
    <span class="d-flex flex-column bg-light w-100 p-5">
        <span class="d-flex justify-content-start bg-light" style="width:700px">
            ...
            <span class="ms-3 mt-2"><strong><p>Category Management</p></strong></span>
        </span>
        ...
        <span>
            <table class="table">
                <thead class="table-dark">
                    <tr>
                        <th scope="col" class="text-start">Supplier Name</th>
                        <th scope="col" class="text-start">Service Offered</th>
                ...
                echo'
                    <tr>
                        <td class="text-start">'.$suppname.'</td>
