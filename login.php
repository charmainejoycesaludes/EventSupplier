  ...
  if($n == "" || $e == ""){
    echo '
        <div class="alert alert-warning d-flex align-items-center" role="alert">
          ...
          $result = mysqli_query($con, "SELECT * FROM signup WHERE fname='$n'");
          //name validation
          if(mysqli_num_rows($result) > 0) {
            //email validation
            
              //password validation
              $result2 = mysqli_query($con, "SELECT * FROM signup WHERE password='$e'");
  ...
  <form method="post">
    <div class="form_container">
        ...
        <div class="title_container">
            ...
            <span class="subtitle">Get started with our web portal, just log in your account and enjoy the experience.</span>
        </div>
        <br>
        ...
        <a href="alivesignup.php" class="sign-in_apl text-decoration-none">
