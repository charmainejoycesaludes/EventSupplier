  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Booking Management</h5>
...
<div class="modal fade" id="service" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Service Management</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="#" class="nav-link active">
              ...
              <a data-bs-toggle="modal" data-bs-target="#register" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Booking Management</p>
              </a>
              <a data-bs-toggle="modal" data-bs-target="#account" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Account Management</p>
                </a>
                <a data-bs-toggle="modal" data-bs-target="#service" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Service Management</p>
                </a>
                <a data-bs-toggle="modal" data-bs-target="#contact" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Contacts</p>
                </a>
            </a>
